...
import com.palascak.android.cstogo.adapters.MyTwitchStreamsAdapter;
        ...
        mAdapter.SetOnItemClickListener(new MyTwitchStreamsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (isTwitchPresent){
                    ...
                    mDialog.title("Twitch app doesn't seem to be installed. Would you like to visit play store to install it?")
                            .positiveAction("VISIT")
                    ...
                    mDialog.positiveActionClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            final String appPackageName = "tv.twitch.android.app"; // getPackageName() from Context or Activity object
                            try {
